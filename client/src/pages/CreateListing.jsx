        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    <div className="flex items-center gap-2">
                        <input type="number" id='reqularPrice' min='0' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex gap-4'>
                    <input className='p-3 border border-gray-300 rounded w-full' type="file" id='imageUrls' accept='image/*' multiple/>
                    <button className='p-3 text-green-600 border border-green-800 rounded uppercase hover:shadow-lg disabled:opacity-80'>Upload</button>
                </div>

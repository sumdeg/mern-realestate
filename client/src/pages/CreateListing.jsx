...
export default function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-5xl mx-auto'>
        <h1 className='text-3xl font-semibold text-center my-7'>İlan Oluştur</h1>
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <button disabled={loading || uploading } className='p-3 bg-blue-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading ? 'Oluşturuluyor...' : 'İlan Oluştur'}</button>

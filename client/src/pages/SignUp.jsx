 ...
 // console.log(formData)
  return (
    <div className='p-3 max-w-lg mx-auto'>
      <h1 className='text-3xl text-center font-bold my-10 uppercase text-gray-700'>Kayıt Ol</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button disabled={loading} className='bg-slate-700 text-white p-4 rounded-lg uppercase hover:opacity-95 disabled:opancity-80'>{loading ? 'Yükleniyor...':'Kayıt Ol'}</button>
        <OAuth/>
      </form>
